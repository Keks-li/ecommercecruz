...
export default function ProductCard({ product }) {
  ...
  return (
    <div className="bg-surface-container rounded-xl border border-outline-variant overflow-hidden group min-w-[80vw] snap-center">
      ...
      <div className="p-sm space-y-base">
        ...
        <p className="text-[12px] text-on-surface-variant">{product.unique_code}</p>
        ...
        <button
          ...
          className={`w-full mt-xs py-2 border rounded-lg text-label-bold transition-colors active:scale-95
            ${flash ? 'bg-emerald-500 text-white border-emerald-500' : 'border-outline hover:bg-surface-container-highest text-on-surface'}`}
        >
